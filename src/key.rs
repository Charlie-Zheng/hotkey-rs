...
impl From<Key> for rdev::Key {
    fn from(value: Key) -> Self {
        match value {
            ...
            Key::Control => rdev::Key::ControlLeft, // Default to left control for the generic Control key
            ...
            Key::Shift => rdev::Key::ShiftLeft, // Default to left shift for the generic Shift key
            ...
            Key::Unknown(code) => rdev::Key::Unknown(code),
        }
    }
}
